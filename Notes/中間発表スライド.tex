...
\begin{frame}{押し出し測度}
    ...
    \begin{figure}[htbp]
        \begin{center}
            \includegraphics[width=120mm]{transport_map2.JPG}
            \caption{transport map}
        \end{center}
    \end{figure}
\end{frame}
    ...
    \begin{figure}[htb]
        \begin{center}
            \begin{minipage}{0.40\hsize}
                \includegraphics[width=\linewidth]{x[iopt]explanation1.JPG}
            \end{minipage}
            \begin{minipage}{0.40\hsize}
                \includegraphics[width=\linewidth]{x[iopt]explanation2.JPG}
            \end{minipage}
        \end{center}
    \end{figure}
