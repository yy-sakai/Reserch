...
\begin{figure}[htbp]
    \begin{center}
        \includegraphics[width=0.5\textwidth]{transport_map2.JPG}
...
\begin{figure}[htb]
    \begin{center}
        \begin{minipage}{0.45\hsize}
            \includegraphics[width=\linewidth]{back-and-forth-update_ex1_0.png}
        \end{minipage}
        \begin{minipage}{0.45\hsize}
            \includegraphics[width=\linewidth]{back-and-forth-update_ex1_19.png}
        \end{minipage}
    \end{center}
    \caption{Example 4.1.}
\end{figure}
...
\begin{ex}
    ...
    \begin{figure}[htb]
        \begin{center}
            \begin{minipage}{0.45\hsize}
                \includegraphics[width=\linewidth]{back-and-forth-update_ex2_0.png}
            \end{minipage}
            \begin{minipage}{0.45\hsize}
                \includegraphics[width=\linewidth]{back-and-forth-update_ex2_19.png}
            \end{minipage}
        \end{center}
        \caption{Example 4.2.}
    \end{figure}
...
\begin{figure}[htbp]
    \begin{center}
        \includegraphics[width=0.7\linewidth]{x[iopt]explanation1.JPG}
        \caption{Transport map $T_{\phi \#} \mu$}
        \includegraphics[width=0.7\linewidth]{x[iopt]explanation2.JPG}
