...
\begin{figure}[htbp]
    \begin{center}
        \includegraphics[width=0.5\textwidth]{image/transport_map2.JPG}
...
\begin{figure}[htbp]
    \begin{center}
        \includegraphics[width=0.7\linewidth]{image/x[iopt]explanation1.JPG}
        \caption{Transport map $T_{\phi \#} \mu$}
        \includegraphics[width=0.7\linewidth]{image/x[iopt]explanation2.JPG}
