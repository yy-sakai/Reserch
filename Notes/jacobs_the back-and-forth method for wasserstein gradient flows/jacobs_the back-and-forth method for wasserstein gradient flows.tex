...
\begin{table}[hbtp]
    ...
    \begin{subtable}{.5\textwidth}
        ...
        \input{../../Codes/result/result_baf_gauss512.tex}
    \end{subtable}
...
\begin{table}[hbtp]
    ...
    \end{subtable}
    \caption{Back and forth method (grid size $1000$)}
\end{table}
...
\begin{table}[hbtp]
    ...
    \end{subtable}
    \caption{Back and forth method (grid size $2000$)}
\end{table}
...
\begin{table}[hbtp]
    ...
    \begin{subtable}{.5\textwidth}
        ...
        \caption{Solving Laplace eq by Gaussian elimination.}
        \label{table:baf_gauss_test}
        \input{../../Codes/result/result_baf_gauss4000.tex}
    \end{subtable}
    \caption{Back and forth method (grid size $4000$)}
\end{table}
