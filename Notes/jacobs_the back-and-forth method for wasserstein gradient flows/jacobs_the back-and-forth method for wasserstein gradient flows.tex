...
\end{table}
  ...
  \begin{figure}
    ...
    \begin{minipage}{0.4\hsize}
        \includegraphics[width=\linewidth]{/Users/sakaiyukito/Downloads/LABO/images/back_and_forth_jacobi_tau/t=0.png}
        \caption{$t = 0$}
    \end{minipage}
    \begin{minipage}{0.4\hsize}
        \includegraphics[width=\linewidth]{/Users/sakaiyukito/Downloads/LABO/images/back_and_forth_jacobi_tau/t=0.4.png}
        \caption{$t = 0.4$}
    \end{minipage}
    \begin{minipage}{0.4\hsize}
        \includegraphics[width=\linewidth]{/Users/sakaiyukito/Downloads/LABO/images/back_and_forth_jacobi_tau/t=0.8.png}
        \caption{$t = 0.8$}
    \end{minipage}
    \begin{minipage}{0.4\hsize}
        \includegraphics[width=\linewidth]{/Users/sakaiyukito/Downloads/LABO/images/back_and_forth_jacobi_tau/t=2.png}
        \caption{$t = 2$}
    \end{minipage}
